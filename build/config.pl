...
my @external = qw(iflport ifport omp_lib ieee_arithmetic netcdf pnetcdf ifcore grib_api iso_c_binding iso_fortran_env mpi omp_lib_kinds eccodes psapi kernel32); 

# Fixed form source files

my @fixed_files = qw(fortran_libraries m1qn3);
