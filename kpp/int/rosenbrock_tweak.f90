...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  USE cbm4_Jacobian, ONLY: Jac_SP, LU_IROW, LU_ICOL
...
!~~~>   Parameters
   ...
   ! JV: arguments changed to parameters:
   KPP_REAL, PARAMETER :: FacMin = 0.2, facMax = 6.0, facRej = 0.1, facSafe = 0.9, hmin = 0.0
   integer, parameter :: max_no_steps = 200000
   logical, parameter :: autonomous = .true., vectortol = .true.
