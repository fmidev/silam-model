...
integer,private,parameter :: Tfm2 = 1056, Ifm2 = 46 ! Forecast time minute Only two chars
integer,private,parameter :: Tfh2 = 1057, Ifh2 = 47 ! Forecast time hour (day persent) Only two chars
integer,private,parameter :: Tfd2 = 1058, Ifd2 = 48 ! Forecast time day  at least two chars

!integer, private, parameter ::  nbr_of_templ_params = 42
integer, private, parameter ::  nbr_of_templ_params = 48
...
function fu_pure_grads_template(Template, chCaseNm, chSrcNm)
  ...
  ! 
  use silam_mpi ! Needed for the task template
  implicit none
  !
...
! Author: M.Sofiev
!
  use silam_mpi ! Needed for the task id
  implicit none
