MODULE optical_density
  ...
  !! Total ozone column (routine that should be moved elsewhere)
  public get_o3column
...
!       endif
  ...
  !Calculate the ozone column above level iLev (in Dobson Units)
  !This routine does not belong to this module, and should be moved to a better place at some point!
