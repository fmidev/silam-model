...
! NONZERO - Number of nonzero entries in Jacobian
  INTEGER, PARAMETER :: NONZERO = 614 
! LU_NONZERO - Number of nonzero entries in LU factoriz. of Jacobian
  INTEGER, PARAMETER :: LU_NONZERO = 681 
! CNVAR - (NVAR+1) Number of elements in compressed row format
  INTEGER, PARAMETER :: CNVAR = 65 
! NHESS - Length of Sparse Hessian
  INTEGER, PARAMETER :: NHESS = 647 
...
!   VAR(ind_spc) = C(ind_spc)
  ...
  INTEGER, PARAMETER :: ind_AVB1e6 = 3 
  INTEGER, PARAMETER :: ind_AVB1e5 = 4 
  INTEGER, PARAMETER :: ind_AVB1e4 = 5 
  INTEGER, PARAMETER :: ind_O1D = 6 
  INTEGER, PARAMETER :: ind_BENZENE = 7 
  INTEGER, PARAMETER :: ind_AVB1e0 = 8 
  INTEGER, PARAMETER :: ind_AVB1e1 = 9 
  INTEGER, PARAMETER :: ind_AVB1e2 = 10 
  INTEGER, PARAMETER :: ind_AVB1e3 = 11 
  INTEGER, PARAMETER :: ind_TOL = 12 
  INTEGER, PARAMETER :: ind_ETHA = 13 
  INTEGER, PARAMETER :: ind_MEOH = 14 
  INTEGER, PARAMETER :: ind_ETOH = 15 
  INTEGER, PARAMETER :: ind_N2O5 = 16 
  INTEGER, PARAMETER :: ind_XYL = 17 
  INTEGER, PARAMETER :: ind_PAN = 18 
  INTEGER, PARAMETER :: ind_BVB1e0 = 19 
  INTEGER, PARAMETER :: ind_BVB1e1 = 20 
  INTEGER, PARAMETER :: ind_BVB1e2 = 21 
  INTEGER, PARAMETER :: ind_SESQ = 22 
  INTEGER, PARAMETER :: ind_BVB1e3 = 23 
  INTEGER, PARAMETER :: ind_H2O2 = 24 
  INTEGER, PARAMETER :: ind_HONO = 25 
  ...
  INTEGER, PARAMETER :: ind_OH = 54 
  INTEGER, PARAMETER :: ind_XO2N = 55 
  INTEGER, PARAMETER :: ind_O = 56 
  INTEGER, PARAMETER :: ind_C2O3 = 57 
  INTEGER, PARAMETER :: ind_NO3 = 58 
  INTEGER, PARAMETER :: ind_HO2 = 59 
  INTEGER, PARAMETER :: ind_XO2 = 60 
  INTEGER, PARAMETER :: ind_PAR5 = 61 
  INTEGER, PARAMETER :: ind_CXO3 = 62 
  INTEGER, PARAMETER :: ind_NO = 63 
  INTEGER, PARAMETER :: ind_NO2 = 64 
