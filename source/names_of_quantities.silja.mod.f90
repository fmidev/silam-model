...
!  USE work_arrays
  ...
  INTEGER, PARAMETER, PUBLIC :: advection_moment_X_flag = 260007  ! For Galperin's advection
  INTEGER, PARAMETER, PUBLIC :: advection_moment_Y_flag = 260008  ! For Galperin's advection
  INTEGER, PARAMETER, PUBLIC :: advection_moment_Z_flag = 260009  ! For Galperin's advection
  integer, parameter, public :: heatsum_flag = 260010             ! [degree day, degree_hour, bioday]
  integer, parameter, public :: chillsum_flag = 260011             ! [degree day, degree_hour, bioday]
  integer, parameter, public :: pollen_rdy_to_fly_flag = 260012  ! [grains]
  integer, parameter, public :: allergen_rdy_to_fly_flag= 260013

  integer, parameter, public :: physiography_field_set_flag = 260014 ! Not real variable but set
  !
  ...
  ! are possible
  integer, parameter, public :: interp_met2disp_coef_flag = 260015
  integer, parameter, public :: interp_met2out_coef_flag = 260016
  integer, parameter, public :: interp_disp2out_coef_flag = 260017

  !
  ! Diagnostic quantities
  !
  integer, parameter, public :: concentration_2m_flag = 260018
  integer, parameter, public :: optical_density_flag = 260019  ! 3D quantity
  integer, parameter, public :: optical_column_depth_flag = 260020  ! 2D column-integrated
  INTEGER, PARAMETER, PUBLIC :: absorption_coef_flag = 260021   ! 3D quantity, m-1
  INTEGER, PARAMETER, PUBLIC :: scattering_coef_flag = 260022   ! 3D quantity, m-1
  INTEGER, PARAMETER, PUBLIC :: back_scattering_coef_flag = 260023   ! 3D quantity, m-1


  integer, parameter, public :: volume_mixing_ratio_flag = 260024  

  integer, parameter, public :: dispersion_u_flag = 260025
  integer, parameter, public :: dispersion_v_flag = 260026
  integer, parameter, public :: dispersion_w_flag = 260027

  integer, parameter, public :: aerosol_flag = 260028

  integer, parameter, public :: cell_size_z_flag = 260029 ! m 
  integer, parameter, public :: air_density_flag = 260030

  integer, parameter, public :: emission_scaling_flag = 260031

  integer, parameter, public :: emis_factor_fire_flame_flag = 260032
  integer, parameter, public :: emis_factor_fire_smold_flag = 260033

  integer, parameter, public :: z_layertop_flag = 260034 !Metric height of disp. layer top
  integer, parameter, public :: p_layertop_flag = 260035 ! Pressure at  disp. layer top
  integer, parameter, public :: disp_flux_cellt_rt_flag = 260036 !Mass flux upwards through cell top, diagnozed (kg/s)
  integer, parameter, public :: disp_flux_celle_rt_flag = 260037 !Mass flux rightwards through cell boarder, diagnozed (kg/s)
  integer, parameter, public :: disp_flux_celln_rt_flag = 260038 !Mass flux thirthwards through cell  boarder, (kg/s)
  integer, parameter, public :: disp_flux_celleast_flag = 260039 !Mass flux rightwards through the cell right (east) side
  integer, parameter, public :: disp_flux_cellnorth_flag = 260040 !Mass flux forward through the cell front (north) side 
  integer, parameter, public :: disp_flux_celltop_flag = 260041 !Mass flux forward through the cell front (north) side 
  integer, parameter, public :: disp_cell_airmass_flag = 260042 !Mass inside a dispersion cell

  integer, parameter, public :: cloud_cond_nucley_nbr_cnc_flag = 260043  ! cloud condensation nucley, [#/m3]
  integer, parameter, public :: ice_nucley_nbr_cnc_flag = 260044  ! ice nucley, [#/m3]

  integer, parameter, public :: reaction_rate_flag = 260045 ! Reaction rate (silam amount units / sec)
  integer, parameter, public :: Vd_correction_DMAT_flag = 260046

  INTEGER, PARAMETER, PUBLIC :: emission_flux_flag = 260047 ! instant emission rate (kg/s)
...
!      fMinAlert = -1; fMinForce = 0; fMaxForce = 1; fMaxAlert = 10
     ...
     fMinAlert = -10; fMinForce = 0; fMaxForce = 1e5; fMaxAlert = 1e6
      ...
      case(leaf_area_index_flag, leaf_area_indexhv_flag, leaf_area_indexlv_flag)
      fMinAlert = -10; fMinForce = 0; fMaxForce = 100; fMaxAlert = 1e3
