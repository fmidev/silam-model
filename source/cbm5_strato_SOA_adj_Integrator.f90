...
MODULE cbm5_strato_SOA_adj_Integrator

   USE cbm5_strato_SOA_Precision
   USE cbm5_strato_SOA_Parameters
   USE cbm5_strato_SOA_Global
   USE cbm5_strato_SOA_LinearAlgebra
   !USE cbm5_strato_SOA_adj_Rates
   USE cbm5_strato_SOA_Function
   USE cbm5_strato_SOA_Jacobian
   USE cbm5_strato_SOA_Hessian
   !<USE cbm5_strato_SOA_adj_Util
...
CONTAINS ! Routines in the module cbm5_strato_SOA_adj_Integrator
...
END MODULE cbm5_strato_SOA_adj_Integrator
