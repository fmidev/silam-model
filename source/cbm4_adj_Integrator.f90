...
MODULE cbm4_adj_Integrator

   USE cbm4_Precision
   USE cbm4_Parameters
   USE cbm4_Global
   USE cbm4_LinearAlgebra
   !USE cbm4_adj_Rates
   USE cbm4_Function
   USE cbm4_Jacobian
   USE cbm4_Hessian
...
CONTAINS ! Routines in the module cbm4_adj_Integrator
...
!!$     END IF
     IF (VectorTol) THEN
       Scale = max(abstol(i), reltol(i)*abs(ynew(i)))  !AbsTol(i)+RelTol(i)*Ymax
     ELSE
       print *, 'not working'
       stop
     END IF
...
END MODULE cbm4_adj_Integrator
