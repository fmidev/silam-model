...
MODULE cbm4_SOA_adj_Integrator

   USE cbm4_SOA_Precision
   USE cbm4_SOA_Parameters
   USE cbm4_SOA_Global
   USE cbm4_SOA_LinearAlgebra
   !USE cbm4_SOA_adj_Rates
   USE cbm4_SOA_Function
   USE cbm4_SOA_Jacobian
   USE cbm4_SOA_Hessian
   !<USE cbm4_SOA_adj_Util
...
CONTAINS ! Routines in the module cbm4_SOA_adj_Integrator
...
END MODULE cbm4_SOA_adj_Integrator
