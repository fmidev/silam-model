...
CONTAINS
  ...
  subroutine prepare_step_cbm4_SOA(if_report_rates, photoarr)
    ...
    if (present(if_report_rates)) then
      ...
      if (if_report_rates) then
        ...
        !call set_rates_cbm4_SOA(photoarr, temp=300.0, cAir=cAir, press=101325.0, cH2O=0.01) !Without SOA
  ...
  subroutine transform_cbm4_SOA(vSp, photo, rules, metdat, timestep_sec, garbage, &
    ...
    !call set_rates_cbm4_SOA(photo, tempr, cAir, fPressure, cH2O) !Without SOA
