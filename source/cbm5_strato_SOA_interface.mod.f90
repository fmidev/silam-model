...
contains
   ...
   subroutine set_rates_cbm5_strato_SOA(photoarr, temp, cAir, press, cH2O&
    ...
    RCONST(247) = (k3rd_iup_pow(4.2d-31,2.4d0,2.7d-11,0.0d0,0.55d0))
    RCONST(248) = (ARRZ(4.5d-12,-500d0))
    ! RCONST(249) = constant rate coefficient
    RCONST(250) = (ARRZ(1.7d-11,-250d0))
    RCONST(251) = (ARRZ(5.8d-12,1500d0))
    RCONST(252) = (ARRZ(1.2d-10,430d0))
    RCONST(253) = (photoarr(pd_brono2))
    RCONST(254) = (photoarr(pd_brcl))
    RCONST(255) = (photoarr(pd_hobr))
    RCONST(256) = (photoarr(pd_bro))
    RCONST(257) = (photoarr(pd_br2))
    RCONST(258) = (photoarr(pd_brno2))
    RCONST(259) = (photoarr(pd_h2o))
    RCONST(260) = (photoarr(pd_ch4))
    RCONST(261) = (photoarr(pd_co2))
    RCONST(262) = (photoarr(pd_no))
    RCONST(263) = (1.5d-10)
    RCONST(264) = (ARRZ(2.1d-11,-100d0))
    RCONST(265) = (ARRZ(1.5d-11,3600d0))
    RCONST(266) = (ARRZ(5.8d-12,-220d0))
    RCONST(267) = (k3rd_iup_pow(4.3d-32,1.2d0,9.5d-11,-0.44d0,0.5d0))
    RCONST(268) = (ARRZ(1.4d-10,470d0))
    RCONST(269) = (8.0d-11)
    RCONST(270) = (ARRZ(4.0d-10,340d0))
    RCONST(271) = (photoarr(pd_ch3cl))
    RCONST(272) = (ARRZ(2.1d-12,1210d0))
    RCONST(273) = (ARRZ(1.8d-11,1081d0))
    RCONST(274) = (photoarr(pd_ch3br))
    RCONST(275) = (ARRZ(1.7d-12,1215d0))
    RCONST(276) = (photoarr(pd_cfc11))
    RCONST(277) = (photoarr(pd_cfc12))
    RCONST(278) = (photoarr(pd_ccl4))
    RCONST(279) = (photoarr(pd_ch3ccl3))
    RCONST(280) = (ARRZ(1.2d-12,1440d0)*MCF_factor)
    RCONST(281) = (ARRZ(1.8d-12,-340.0d0)*SOA_b)
    RCONST(282) = (1.51e-11*SOA_b)
    RCONST(283) = (ARRZ(2.3d-12,190.0d0)*SOA_b)
    RCONST(284) = (3.60E-11*SOA_b)
    RCONST(285) = (ARRZ(2.7d-11,-390.0d0)*SOA_b)
    RCONST(286) = (ARRZ(1.05d-14,2000.0d0)*SOA_b)
    RCONST(287) = (ARRZ(2.95d-12,450.0d0)*SOA_b)
    RCONST(288) = (3.60E-11*SOA_b)
    RCONST(289) = (ARRZ(1.5d-11,-449.0d0)*SOA_b)
    RCONST(290) = (ARRZ(1.2d-15,821.0d0)*SOA_b)
    RCONST(291) = (ARRZ(3.7d-12,-175.0d0)*SOA_b)
    RCONST(292) = (ARRZ(1.8d-12,-340.0d0)*(1.0-SOA_b))
    RCONST(293) = (1.51e-11*(1.0-SOA_b))
    RCONST(294) = (ARRZ(2.3d-12,190.0d0)*(1.0-SOA_b))
    RCONST(295) = (3.60E-11*(1.0-SOA_b))
    RCONST(296) = (ARRZ(2.7d-11,-390.0d0)*(1.0-SOA_b))
    RCONST(297) = (ARRZ(1.05d-14,2000.0d0)*(1.0-SOA_b))
    RCONST(298) = (ARRZ(2.95d-12,450.0d0)*(1.0-SOA_b))
    RCONST(299) = (3.60E-11*(1.0-SOA_b))
    RCONST(300) = (ARRZ(1.5d-11,-449.0d0)*(1.0-SOA_b))
    RCONST(301) = (ARRZ(1.2d-15,821.0d0)*(1.0-SOA_b))
    RCONST(302) = (ARRZ(3.7d-12,-175.0d0)*(1.0-SOA_b))
