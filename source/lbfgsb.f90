...
c-jlm-jn 
     ...
     +  csave,lsave,isave(22),dsave, unitPrint)
...
c======================= The end of setulb =============================
     ...
     +                  iprint, csave, lsave, isave, dsave, unitPrint)
      ...
      character*60     task, csave
      logical          lsave(4)
      integer          n, m, iprint, nbd(n), index(n), unitPrint, 
...
c           'info' records the termination information.
         ...
         itfile = unitPrint    ! we open file above and just push the unit here.
